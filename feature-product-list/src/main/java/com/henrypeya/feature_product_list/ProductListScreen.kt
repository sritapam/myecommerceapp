    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = { navController.navigate("cart_route") }) { // Navegar al carrito
        ...
        Column(
            ...
            // Controles de Filtrado y Ordenamiento (PI 7)
            Row(
                modifier = Modifier.fillMaxWidth(),
            ...
            // Indicador de carga, error o lista de productos
...
// Composable para cada ítem de producto
@Composable
        ...
        Column(
            ...
            AsyncImage(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .height(120.dp),
                contentScale = androidx.compose.ui.layout.ContentScale.Crop // Ajusta la escala de la imagen
            )
            ...
            Row(
                ...
                if (product.includesDrink) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Icon(Icons.Default.Star, contentDescription = "Incluye bebida")
...
// Composable para el filtro de categoría
@Composable
fun CategoryFilter(
...
// Composable para el selector de ordenamiento
@Composable
